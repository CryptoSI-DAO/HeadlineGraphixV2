...
const GenerateContentDraftsOutputSchema = z.object({
  ...
  infographicImage: z
    .string()
    .describe(
      'A data URI for the generated infographic image, that must include a MIME type and use Base64 encoding. Expected format: \'data:<mimetype>;base64,<encoded_data>\'.' 
    ).optional(),
});
...
const prompt = ai.definePrompt({
  ...
  If you can't generate the infographic image URL, leave it blank.
